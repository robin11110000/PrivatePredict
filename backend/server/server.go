...
import (
	...
	"net/http"
	"os"
	"PrivatePredict/handlers"
	adminhandlers "PrivatePredict/handlers/admin"
	betshandlers "PrivatePredict/handlers/bets"
	buybetshandlers "PrivatePredict/handlers/bets/buying"
	sellbetshandlers "PrivatePredict/handlers/bets/selling"
	"PrivatePredict/handlers/cms/homepage"
	cmshomehttp "PrivatePredict/handlers/cms/homepage/http"
	marketshandlers "PrivatePredict/handlers/markets"
	metricshandlers "PrivatePredict/handlers/metrics"
	positions "PrivatePredict/handlers/positions"
	setuphandlers "PrivatePredict/handlers/setup"
	statshandlers "PrivatePredict/handlers/stats"
	usershandlers "PrivatePredict/handlers/users"
	usercredit "PrivatePredict/handlers/users/credit"
	privateuser "PrivatePredict/handlers/users/privateuser"
	"PrivatePredict/handlers/users/publicuser"
	"PrivatePredict/middleware"
	"PrivatePredict/security"
