...
__SP_ROOT_DIR="${PrivatePredict_ROOT:-$(cd "${__SP_DEV_DIR}/.." && pwd)}"
...
export BACKEND_IMAGE_NAME=${BACKEND_IMAGE_NAME:-PrivatePredict-dev-backend}
export FRONTEND_IMAGE_NAME=${FRONTEND_IMAGE_NAME:-PrivatePredict-dev-frontend}
...
BACKEND_IMAGE_NAME="${BACKEND_IMAGE_NAME:-PrivatePredict-dev-backend}"
FRONTEND_IMAGE_NAME="${FRONTEND_IMAGE_NAME:-PrivatePredict-dev-frontend}"
...
echo "Images built."
echo "Use "./PrivatePredict up" to start the containers"
echo "And "./PrivatePredict down" to stop them."
