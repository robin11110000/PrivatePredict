  ...
  return (
    <div className='flex flex-col h-full text-white p-4 md:p-6 lg:p-8'>
      <h1 className='text-2xl md:text-3xl font-bold mb-4'>
        About PrivatePredict
      </h1>
      <div className='bg-gray-800 rounded-lg shadow-lg flex-grow overflow-auto'>
        <div className='p-4 md:p-6 space-y-4 md:space-y-6'>
          <p className='text-center'>
            <a
              href='https://github.com/openpredictionmarkets/PrivatePredict'
              target='_blank'
              rel='noopener noreferrer'
              className='text-blue-400 hover:text-blue-300 transition-colors duration-200'
            >
              📈 Built with PrivatePredict <br /> ⭐ Star Us on Github!
            </a>
          </p>
          ...
          <section>
            ...
            <p className='mb-2'>PrivatePredict is Open Source Software Which:</p>
            <ul className='list-disc list-inside pl-4'>
              <li>
          ...
          <section>
            ...
            <ul className='list-disc list-inside pl-4 space-y-2'>
              ...
              <li>
                <a
                  href='https://github.com/openpredictionmarkets/PrivatePredict/issues'
                  target='_blank'
                  rel='noopener noreferrer'
                  className='text-blue-400 hover:text-blue-300 transition-colors duration-200'
                >
              ...
              <li>
                <a
                  href='https://github.com/openpredictionmarkets/PrivatePredict/blob/main/README.md'
                  target='_blank'
                  rel='noopener noreferrer'
                  className='text-blue-400 hover:text-blue-300 transition-colors duration-200'
                >
