    ...
    <div className='overflow-auto'>
      ...
      <div className='bg-primary-background p-6'>
        ...
        <p className='text-gray-300 mb-4'>
          Mobile-responsive grid patterns used throughout PrivatePredict. These components adapt from mobile-first 
      ...
      <div className='bg-primary-background p-6'>
        <h2 className='text-2xl font-bold text-white mb-6'>PrivatePredict Color Palette</h2>
