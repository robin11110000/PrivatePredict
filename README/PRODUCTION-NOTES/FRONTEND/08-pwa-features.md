...
const CACHE_NAME = 'PrivatePredict-v1.0.0'
...
self.addEventListener('push', (event) => {
  ...
  const options = {
    ...
    image: data.image,
    tag: data.tag || 'PrivatePredict-notification',
    data: data.data,
    ...
    VitePWA({
      ...
      workbox: {
        ...
        runtimeCaching: [
          ...
          {
            urlPattern: /^https:\/\/api\.PrivatePredict\.com\/api\/users/,
            handler: 'NetworkFirst',
            options: {
              cacheName: 'api-users',
              expiration: {
...
const OFFLINE_STORAGE_KEY = 'PrivatePredict-offline'
