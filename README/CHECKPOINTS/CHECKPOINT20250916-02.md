...
Bake the rendered vite.config.mjs into the prod image during ./PrivatePredict install (prod).
...
#   ENV_PATH=/root/PrivatePredict-deploy/.env scripts/prod/env_writer_prod.sh
...
#
# Requires FRONTEND_IMAGE_NAME in your .env (e.g., PrivatePredict-frontend).
