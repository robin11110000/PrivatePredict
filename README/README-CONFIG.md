...
* The economics of PrivatePredict can be customized upon set up based upon entries in a YAML file.
...
* These are global variables which effect the operation of the entire software suite and for now are meant to be set up permanently for the entirety of the run of a particular instance of PrivatePredict.
